...
/**
 * Created by José Ángel García Salinas on 07/09/14.
 * Esta clase crea las listas de eventos, ponentes, empresas y lugares para
 * ser utilizadas y llamas de manera estática en toda la aplicación.
 */
public class Listas {
    ...
    /**
     * Al creal el objeto listas inizializamos las listas con la información de los eventos. etc.
     */
    public Listas() {
    ...
    /**
     * Metodo que devuelve la lista de eventos por lugar donde se realizarán,
     * @param lugar id del ligar
    ...
    /**
     * Método que llena la lista de eventos
     */
    private void setUpEventos() {
        ...
        eventos.add(new Evento(21, "Internet of everything", "16:00", "17:00", 23, 1, R.drawable.cisco, "18/09/2014"));
        eventos.add(new Evento(23, "Microsoft y el ¿Código libre ?", "17:00", "18:00", 24, 1, R.drawable.microsoft, "18/09/2014"));
    ...
    /**
     * Método que llena la lista de ponentes.
     */
    ...
    /**
     * Método que llena la lista de empresas
     */
    ...
    /**
     * Método que llena lista de lugares
     */
    private void setUpLugares() {
        lugares.add(new Lugar(0, "Auditorio Carlos Graef", 19.3240808, -99.1806862));
