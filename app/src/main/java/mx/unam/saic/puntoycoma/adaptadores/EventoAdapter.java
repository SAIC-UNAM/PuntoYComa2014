...
/**
 * Created by José Ángel García Salinas on 05/09/14.
 * Clase que define el adaptador de la lista de eventos, la cual se muestra dependiendo el día
 * en el fragmentro EventoFragment
 */
public class EventoAdapter extends RecyclerView.Adapter<EventoAdapter.ViewHolder> {
    ...
    /**
     * Constructor que crea el adaptador, recibe la lista de los eventos y el contexto
     * @param items Lista de eventos
    ...
    /**
     * En esta clase definiremos los widgets de cada elemento del RecyclerView (Antes ListView)
     *
     */
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * Metodo que recibe la vista en la cual están están estos widgets
         * @param v la vista
         */
    ...
    /**
     * Método que devuelve el viewholder para cada elemento del recicler view
    ...
    /**
     *Método en el cual podremos modificar nuestros widgets libremente al.
    ...
    /**
     * Método que hace que al apretar el nombre de una empresa en la app, se muestre la opción de ir su twitter
     * @param emp empresa seleccionada
     */
    ...
    /**
     * Método que al apretar el nombre del ponente, muestra un díalogo en el cual nos permite abrir twitter
     * @param pon ponente seleccionado
     */
    ...
    /**
     * Metodo que inicia la actividad ya sea para abrir un facebook o twitter de algún ponente o empresa
     * @param i opcion fb o tw
     * @param s string del perfil o timeline
     */
    ...
    /**
     * Método que agenta un evento en el calendario del dispositivo
     * @param evento
     * @param lugar
     */
        ...
        endMillis = horafinal.getTime();
         ...
         if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            try {
                ...
                Toast.makeText(contexto,"Ocurrió un error, lo resolveremos lo antes posible!",Toast.LENGTH_SHORT).show();
            }
         }
    }

    /**
     * Método que regresa la cuenta de elementos en el adaptador
